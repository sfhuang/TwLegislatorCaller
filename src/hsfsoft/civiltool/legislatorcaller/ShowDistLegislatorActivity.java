...
public class ShowDistLegislatorActivity extends Activity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.contact_dist_legislator_layout);

        LegislatorDB helper = new LegislatorDB(this);
        final SQLiteDatabase db = helper.getReadableDatabase();

        //查詢分區立委資料
       	Cursor c = db.query("LEGISLATOR_DATA", new String[]{"legislator_id","legislator_name"},"legislator_dist_id<>9999",null,null,null,null);
        	c.moveToFirst();
                    	   ...
                    	   if(showedCount<dataCount)
                    	   {
	       	                   ...
	       	                   b.setOnClickListener(new Button.OnClickListener(){
	       	                	   public void onClick(View v){
	       	                		   Intent intent=new Intent(ShowDistLegislatorActivity.this,ShowLegislatorDataActivity.class);
