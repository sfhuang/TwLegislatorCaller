...
public class ShowPartyLegislatorActivity extends Activity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.show_legislator_by_party_layout);
        ...
        if(extraData != null){
        	TextView textViewToken = (TextView)findViewById(R.id.textviewPartyName);
        	String PARTY_ID=(String) extraData.getCharSequence("PARTY_ID");

        	//查詢各政黨立委名單
        	Cursor c = db.query("LEGISLATOR_DATA", new String[]{"legislator_id","legislator_name"},"legislator_party_id="+PARTY_ID,null,null,null,null);
        	c.moveToFirst();
                    	   ...
                    	   if(showedCount<dataCount)
                    	   {
	       	                   ...
	       	                   b.setOnClickListener(new Button.OnClickListener(){
	       	                	   public void onClick(View v){
	       	                		   Intent intent=new Intent(ShowPartyLegislatorActivity.this,ShowLegislatorDataActivity.class);
        	...
        	textViewToken.setText(party_List[Integer.parseInt(PARTY_ID)]);
        	c.close();
        }
        db.close();
    }
